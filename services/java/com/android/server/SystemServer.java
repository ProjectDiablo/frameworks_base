...
import org.rising.server.AdaptiveSoundEngineService;
...
public final class SystemServer implements Dumpable {
    ...
    private void startOtherServices(@NonNull TimingsTraceAndSlog t) {
       ...
       if (isWatch) {
        ...
        t.traceBegin("StartAdaptiveSoundEngineService");
        mSystemServiceManager.startService(ADAPTIVE_SOUND_ENGINE_SERVICE_CLASS);
        t.traceEnd();
