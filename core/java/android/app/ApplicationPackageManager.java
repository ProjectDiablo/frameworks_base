...
public class ApplicationPackageManager extends PackageManager {
    ...
    public boolean hasSystemFeature(String name, int version) {
        ...
        boolean isGPhotosPackage = "com.google.android.apps.photos".equals(packageName);
        boolean isGooglePackages = googlePackages.contains(packageName);
        if (isGPhotosPackage) {
            ...
            if (featuresPixelTensor.contains(name) || featuresPixel.contains(name) || featuresAndroid.contains(name)) {
                return true;
            }
        }
